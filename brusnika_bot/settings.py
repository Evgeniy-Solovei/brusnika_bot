"""
Django settings for brusnika_bot project.
...
SECRET_KEY = 'django-insecure-$arwn**^a7!3j11+tsrax9t!4ds9#7($$il%=8@6nmgp+-^@!d'
...
ROOT_URLCONF = 'brusnika_bot.urls'
...
WSGI_APPLICATION = 'brusnika_bot.wsgi.application'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'e.v.solovey@inbox.ru'
EMAIL_HOST_PASSWORD = 'pKRaUwwJXczKutFCvRhm'
EMAIL_USE_SSL = True
DEFAULT_FROM_EMAIL = 'e.v.solovey@inbox.ru'
