...
faq_data = [
    ...
    {"question": "Когда мне вернут залог?", "answer": "В день Вашего выезда горничная приходит, проверяет квартиру и после этого возвращаем залог. Время возврата – в течении дня."},
]
